...
# Nutriënten randzone
plot_Nutrienten_R <- nutriënten_R %>%
  ggplot(aes(x = FieldSamplingDate, y = ResultCalc, color = AquaComponent)) + 
  geom_line() + 
  geom_point() +
  scale_x_date(date_breaks = "1 month", date_labels = "%b-%Y") +
...
# Nutriënten zonnepanelen
plot_Nutrienten_ZP <- nutriënten_ZP %>%
  ggplot(aes(x = FieldSamplingDate, y = ResultCalc, color = AquaComponent)) + 
  geom_line() + 
  geom_point() +
  scale_x_date(date_breaks = "1 month", date_labels = "%b-%Y") +
  labs(title = "Nutriëntenlast zonnepanelen") +
  xlab("Datum staalname") + 
  ylab("Meetwaarde (mg/L)") + 
  scale_color_discrete("Variabelen")
plot_Nutrienten_ZP

# Vergelijking rand vs. zonnepanelen
plot_verg_nutr <- ggarrange(plot_Nutrienten_R, plot_Nutrienten_ZP, nrow = 1, common.legend = TRUE) + scale_color_discrete("Variabelen")
ggsave(plot_verg_nutr, 
         filename = paste0("./exports/plot_meetreeks_", "nutriënten","_", i,".jpg"), 
