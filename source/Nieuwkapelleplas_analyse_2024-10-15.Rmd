...
maak_figuur <- function(dataset, component, naam, title = NULL, xas = NULL, yas = NULL){
  figuur <- dataset %>%
...
plotTN <- ggplot(data = cum_TN, aes(x = FieldSamplingDate, y = CumulativeSum, linetype = FieldSampleID)) + 
...
plotTP <- ggplot(data = cum_TP, aes(x = FieldSamplingDate, y = CumulativeSum, linetype = FieldSampleID)) + 
  geom_line(color = "orange") + 
  geom_point(color = "orange") +
